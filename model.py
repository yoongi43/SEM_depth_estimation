...
class DepthEstimation2(nn.Module):
    def __init__(self, ic=1, n_conformer=4):
        ...
        self.enc1 = ConvBlock(ic=ic, oc=4, k=3, s=1, p='same')
        self.enc2 = ConvBlock(ic=4, oc=16, k=3, s=1, p='same')
        ...
        self.dec2 = ConvBlock(ic=16, oc=4, k=3, s=1, p='same')
        self.dec1 = ConvBlock(ic=4, oc=1, k=3, s=1, p='same')
